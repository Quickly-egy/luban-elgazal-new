...
const StatisticsSection = () => {
  ...
  const statistics = useMemo(() => ([
    {
      ...
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
          <path d="M12 12C14.76 12 17 9.76 17 7C17 4.24 14.76 2 12 2C9.24 2 7 4.24 7 7C7 9.76 9.24 12 12 12Z" fill="currentColor" />
  ...
  const animateValue = useCallback((start, end, duration, callback) => {
          ...
          statistics.forEach((stat) => {
            animateValue(0, stat.value, 2000, (value) => {
              setAnimatedValues((prev) => {
                if (prev[stat.id] === stat.value) return prev; // Avoid redundant updates
  ...
  }, [isVisible, animateValue, statistics]);
