...
const WhyChooseUs = () => {
  const features = [
    ...
    },
    {
      ...
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M17 12C17 14.7614 14.7614 17 12 17M17 12C17 9.23858 14.7614 7 12 7M17 12H22M12 17C9.23858 17 7 14.7614 7 12M12 17V22M7 12C7 9.23858 9.23858 7 12 7M7 12H2M12 7V2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      ),
      bgColor: "#8b5cf6",
    ...
    },
    {
      ...
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M18.5 8C19.9045 9.40457 19.9045 11.5954 18.5 13M21 5.5C23.0516 7.55163 23.0516 10.4484 21 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
      bgColor: "#10b981",
    ...
    <section className={styles.whyChooseUs}>
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>نقدم لك أفضل تجربة تسوق، مع ضمان الجودة والخدمة المتميزة</p>
        </div>
