...
export default function OTPModal({
  ...
  const { verifyRegistration, resendVerification, pendingRegistration } =
    useAuthStore();
  ...
  return (
    <aside
      className={`${styles.authModal} ${showOTPModal ? styles.show : ""}`}
    ...
    >
      ...
      >
        ...
        <form className={styles.authForm} onSubmit={handleSubmit}>
          ...
          {/* Verification code is sent via WhatsApp and should not be displayed in the UI for security reasons */}
          ...
          >
            {isLoading ? <div className={styles.spinner}></div> : "تأكيد الكود"}
          </button>
