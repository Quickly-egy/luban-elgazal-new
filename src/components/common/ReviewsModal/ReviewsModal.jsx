...
const ReviewsModal = ({ isOpen, onClose, product }) => {
  ...
  const randomArabicNames = [
    'أحمد محمد', 'فاطمة أحمد', 'محمد علي', 'سارة حسن', 'خالد عبدالله',
    'نورا محمود', 'يوسف إبراهيم', 'مريم سالم', 'حسام فتحي', 'دينا عماد',
    'طارق صالح', 'هند ناصر', 'كريم وائل', 'لمياء حسين', 'عمر طه',
    'ياسمين رشدي', 'سامح نبيل', 'منى عادل', 'باسم مصطفى', 'رنا أشرف',
    'شريف كمال', 'هبة سمير', 'ماجد حامد', 'ندى رمضان', 'أمين فاروق',
    'سلمى جمال', 'وليد صبري', 'رغد محسن', 'عماد زكي', 'لينا سليم'
  ];
  ...
  const getRatingCount = (rating) => {
    ...
    switch(rating) {
      case 5: return distribution['5_stars'] || 0;
      case 4: return distribution['4_stars'] || 0;
      case 3: return distribution['3_stars'] || 0;
      case 2: return distribution['2_stars'] || 0;
      case 1: return distribution['1_star'] || 0;
      default: return 0;
    }
  };
    ...
    <div className={styles.modalOverlay} onClick={handleOverlayClick}>
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.productInfo}>
          <img 
            src={productData?.main_image_url || productData?.image || productData?.images?.[0] || 'https://via.placeholder.com/100x100?text=صورة'} 
            alt={productData?.name} 
            className={styles.productImage}
            onError={(e) => {
              e.target.src = 'https://via.placeholder.com/100x100?text=صورة+المنتج';
            }}
          />
