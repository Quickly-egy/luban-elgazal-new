      ...
      <div className={styles.deleteModalContent}>
        ...
        <div className={styles.deleteModalBody}>
          ...
          <div className={styles.addressPreview}>
            <p>
              <strong>{addressDetails.address_line1}</strong>
            </p>
            {addressDetails.address_line2 && (
              <p>{addressDetails.address_line2}</p>
            )}
...
export default function ShippingInfoModal({ isOpen, onClose,countriesWithPostalCodes }) {
  ...
  return (
    <>
      <div
        className={styles.shippingModalOverlay}
        onClick={(e) => e.target === e.currentTarget && onClose()}
      >
        <div className={styles.shippingModalContainer}>
          <div className={styles.shippingModalHeader}>
            <div className={styles.headerContent}>
              ...
              <div className={styles.headerText}>
                <h3>عناوين الشحن</h3>
                <p>إدارة عناوين الشحن والتوصيل</p>
              </div>
            </div>
          ...
          <div className={styles.shippingModalContent}>
            {/* Success Message */}
            {successMessage && (
            ...
            {!isEditing && (
              <div className={styles.addressesList}>
                <button onClick={handleAddNew} className={styles.addAddressBtn}>
                ...
                {isLoadingAddresses ? (
                  ...
                  <div className={styles.noAddresses}>لا توجد عناوين مسجلة</div>
                )}
              </div>
            )}
