...
import { FaCheckCircle, FaWhatsapp, FaArrowRight, FaBox, FaGift } from 'react-icons/fa';
            ...
            <div className={styles.container}>
                <div className={styles.successCard}>
                    <div className={styles.header}>
                        ...
                        <p className={styles.orderDate}>تاريخ الطلب: {formatDate(orderDetails.created_at)}</p>
                    </div>
                    ...
                    <div className={styles.orderDetails}>
                        ...
                        <div className={styles.detailsGrid}>
                            ...
                            <div className={styles.detailItem}>
                                ...
                                <span className={styles.finalPrice}>{orderDetails.final_amount}</span>
                            </div>
                            <div className={styles.detailItem}>
                                <span>طريقة الدفع:</span>
                                <span>{orderDetails.payment_method === 'cash' ? 'الدفع عند الاستلام' : 'تابي'}</span>
                            </div>
                        </div>
                    </div>
                            ...
                            {orderDetails.products.map((product, index) => (
                                <div key={`product-${index}`} className={styles.productItem}>
                                    ...
                                    <div className={styles.productDetails}>
                                        ...
                                        <p className={styles.productTotal}>المجموع: {product.total_price} ريال</p>
                                    </div>
                                </div>
                            ))}
                            {orderDetails.packages?.map((pkg, index) => (
                                <div key={`package-${index}`} className={styles.productItem}>
                                    ...
                                    <div className={styles.productDetails}>
                                        ...
                                        <p className={styles.productTotal}>المجموع: {pkg.total_price} ريال</p>
                                    </div>
                                </div>
                            ))}
                        </div>
